...
type PersonnelMeta {
  ...
  interviews(where: PersonnelInterviewWhereInput, orderBy: PersonnelInterviewOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [PersonnelInterview!]
  is_verified: Boolean
  createdAt: DateTime!
  updatedAt: DateTime!
}
...
input PersonnelMetaCreateInput {
  ...
  interviews: PersonnelInterviewCreateManyInput
  is_verified: Boolean
}
...
input PersonnelMetaUpdateInput {
  ...
  interviews: PersonnelInterviewUpdateManyInput
  is_verified: Boolean
}
...
input PersonnelMetaWhereInput {
  ...
  interviews_every: PersonnelInterviewWhereInput
  interviews_some: PersonnelInterviewWhereInput
  interviews_none: PersonnelInterviewWhereInput
  is_verified: Boolean
  is_verified_not: Boolean
  createdAt: DateTime
  createdAt_not: DateTime
